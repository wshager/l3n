...
exports.isClose = exports.isBranch = exports.isLeaf = undefined;
...
function toVNodeStream($s, bufSize = 1) {
	const cx = (0, _vnode.getContext)(this, inode);
					...
					case 1:
						{
							...
							let vnode = new _vnode.VNode(cx, node, type, name, key, isLeaf(type) ? node.valueOf() : null, parent, depth, parent ? parent.count() : 0);
