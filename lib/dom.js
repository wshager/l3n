...
exports.getType = exports.__vnode_context = undefined;
exports.vnode = vnode;
...
// Core API
// -----------------------
const __vnode_context = exports.__vnode_context = "dom";
...
function create(type, nameOrValue) {
	...
	} else if ((0, _convert.isBranch)(type)) {
...
const getType = exports.getType = node => {
	var nodeType = node.nodeType;
	var nodeName = node.nodeName;
	let isElem = nodeType == 1;
