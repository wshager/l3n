...
function _n(type, name, children) {
  ...
  return (0, _fauxVnode.default)(function (parent, ref) {
    ...
    (0, _operators.concatMap)(c => (0, _just.default)((0, _vnode.isVNode)(c) ? typeof c.node == "function" ? c.node(node) : c : _v(3, c + "").node(node))), (0, _operators.reduce)((node, c) => node.modify(c, ref), node));
  }, type, name);
}
